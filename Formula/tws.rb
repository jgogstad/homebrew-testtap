class Tws < Formula
  ...
  url "https://#{username}:#{password}@nexus.tapad.com/repository/releases/com/tapad/workshop/tws/0.0.8/tws-0.0.8.zip"
  ...
  def install
    system "make", "VERSION=0.0.8", "BUILDPATH=#{buildpath}", "CREDENTIALS=#{@@credentials_file}"
    bin.install "tws"
  end
