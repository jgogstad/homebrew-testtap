class Jgows < Formula
  ...
  url "https://#{username}:#{password}@nexus.tapad.com/repository/releases/com/tapad/workshop/jgows/0.1.7/jgows-0.1.7.zip"
  ...
  def install
    system "make", "VERSION=0.1.7", "BUILDPATH=#{buildpath}", "CREDENTIALS=#{@@credentials_file}"
    bin.install "app"
  end
